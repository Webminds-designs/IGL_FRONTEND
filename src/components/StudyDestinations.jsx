      ...
      <div className="text-left pt-10 sm:pt-20">
        ...
        <p className="text-2xl sm:text-3xl lg:text-4xl mt-5 text-gray-800 font-base text-left">
          ...
          <span className="text-gray-400">
            Admissions, Visas, And Financial Aid.
          </span>
          Our Mission Is To Make Studying Abroad{" "}
          <span className="text-gray-400">
            Simple, Stress-Free, And Successful
          </span>
          , Helping Students Excel In Their Academic And Career Paths.
        </p>
        <Link to="/aboutus" className="cursor-pointer">
          <button className="mt-8 px-4 py-2 border font-bold border-black rounded-full hover:bg-black hover:text-white transition-all text-sm sm:text-base cursor-pointer">
            Learn More
          </button>
        </Link>
      </div>
