...
const Navbar = ({ fontColor, bgColor }) => {
  ...
  const getTextColor = () => {
    ...
    const shouldUseDarkText = darkTextRoutes.includes(
  ...
  return (
    <nav
      className={`absolute z-50 top-0 left-0 w-full p-6 md:p-12 ${
      ...
      <div className="flex justify-between items-center w-full">
          ...
          <ul className="flex space-x-12 cursor-pointer">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `text-sm md:text-sm hover:underline ${
        ...
        <div
          className={`absolute top-full left-0 w-full bg-opacity-90 backdrop-blur-lg p-6 transition-transform 
                    ...
                    } lg:hidden ${bgColor || "bg-transparent"}`}
        >
