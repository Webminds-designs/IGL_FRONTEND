...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_rf4dwi8", // Replace with your Email.js service ID
        "template_8jx26q8", // Replace with your Email.js template ID
        {
          from_name: formData.name,
          from_email: formData.email,
          message: formData.message,
        },
        "Gy_U2G1sv98JkAhfs" // Replace with your Email.js public key
      )
      .then(
        (response) => {
          console.log(
